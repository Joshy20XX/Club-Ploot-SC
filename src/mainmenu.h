...
public:
    ...
    void retranslateUi(QWidget *Form)
    {
        ...
        label_3->setText(QCoreApplication::translate("Form", "<html><head/><body><p align=\"center\">A <span style=\" font-style:italic;\">Club Penguin</span>-inspired chat room based on an original game, </p><p align=\"center\"><span style=\" font-style:italic;\">Ploot</span>, inspired by Pikmin</p></body></html>", nullptr));
